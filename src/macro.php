...
if (! function_exists('Amerurl')) {
    function Amerurl($path = null, $parameters = [], $secure = null)
    {
        ...
        return url(config('amer.route_prefix', 'amer').$path, $parameters, $secure);
    }
}
if (! function_exists('amer_middleware')) {
    function amer_middleware()
    {
        return config('amer.middleware_key', 'Amer');
    }
}
if (! function_exists('Amer_guard_name')) {
    ...
    {
        if($type == null){
            return config('amerSecurity.auth.middleware_key', config('auth.defaults.guard'));
        }else{
            return config('employers.auth.middleware_key', config('auth.defaults.guard'));
        }
...
if (! function_exists('authentication_column')) {
    ...
    {
        return config('amer.authentication_column', 'email');
    }
}
...
if (! function_exists('email_column')) {
    ...
    {
        return config('amer.email_column', 'email');
    }
}
...
if (! function_exists('Amerview')) {
    ...
    {
        $originalTheme = 'Amer::';
        $theme = config('amer.view_namespace');
