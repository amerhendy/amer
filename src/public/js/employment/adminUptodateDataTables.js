...
function setcolumns(data){
    columns= [
        ...
        { data: function (data){if(data['Stage_id']['LastEntry']['Message'] == '' || data['Stage_id']['LastEntry']['Message'] == null){data['Stage_id']['LastEntry']['Message']="-";}return limitText(data['Stage_id']['LastEntry']['Message'],10);} },
        //last convert
        ...
        {data:function(row, type, set){if(row.Stage_id.LastStage == null || row.Stage_id.LastStage == 'null' || row.Stage_id.LastStage == ''){return '-';}else{return limitText(row.Stage_id.LastStage.Message,10);}}},
        //Last Stage
        { data: function(data){return data['Stage_id']['Last']['Text'];}},
        { data: function(data){return data['Stage_id']['Last']['Result'];} },
        { data: function (data){if(data['Stage_id']['Last']['Message'] == '' || data['Stage_id']['Last']['Message'] == null){data['Stage_id']['Last']['Message']="-";}return limitText(data['Stage_id']['Last']['Message'],10);} },
        //////////
        { data: function(data){return data['Job_id']['Code']+' :: '+limitText(data['Job_id']['Text'],10);} },
        { data: function(data){return data['Fname']+' '+data['Sname']+' '+data['Tname']+' '+data['Lname']}},
        { data: function(data){return limitText(data['BornGov']+' - '+data['BornCity'],10)} },
        { data: function(data){return limitText(data['LiveGov']+' - '+data['LiveCity']+' - '+data['LiveAddress'],10)}},
        ...
        { data: function(data){
            ...
            $.each(data['Stage_id']['stages'],function(k,M){
                liststages+=`<span role="link" data-data='`+JSON.stringify(M)+`' onclick="viewallstages(this);">`+M['Text']+`</span><br>`
            });
            return liststages;
        }},
        { data: function(data){
            ...
            $.each(data['FileName'],function(k,v){
                if(data['link'] !== null){
                    doewn+=`<a href="`+data['link']+`" target="_blank"><span class="fa fa-download"></span></a>`;
                }
            });
            return doewn;
        }},
...
function columndefs(data){
    columnDefs=[
        //withoutspan
        {target:0,'createdCell':function(td,cellData,rowData,roe,col){if($(td).html() == '-'){$(td).attr('data-search','');}else{$(td).attr('data-search',$(td).html());$(td).attr('data-order',$(td).attr('data-search'));}}},
        {target:1,'createdCell':function(td,cellData,rowData,roe,col){if($(td).html() == '-'){$(td).attr('data-search','');}else{$(td).attr('data-search',$(td).html());$(td).attr('data-order',$(td).attr('data-search'));}}},
        {target:2,'createdCell':function(td,cellData,rowData,roe,col){if($(td).html() == '-'){$(td).attr('data-search','');}else{$(td).attr('data-search',$(td).html());$(td).attr('data-order',$(td).attr('data-search'));}}},
        {target:3,'createdCell':function(td,cellData,rowData,roe,col){if($(td).html() == '-'){$(td).attr('data-search','');}else{$(td).attr('data-search',$(td).html());$(td).attr('data-order',$(td).attr('data-search'));}}},
        {target:4,'createdCell':function(td,cellData,rowData,roe,col){if($(td).html() == '-'){$(td).attr('data-search','');}else{$(td).attr('data-search',$(td).html());$(td).attr('data-order',$(td).attr('data-search'));}}},
        {target:6,'createdCell':function(td,cellData,rowData,roe,col){if($(td).html() == '-'){$(td).attr('data-search','');}else{$(td).attr('data-search',$(td).html());$(td).attr('data-order',$(td).attr('data-search'));}}},
        {target:7,'createdCell':function(td,cellData,rowData,roe,col){if($(td).html() == '-'){$(td).attr('data-search','');}else{$(td).attr('data-search',$(td).html());$(td).attr('data-order',$(td).attr('data-search'));}}},
        {target:9,'createdCell':function(td,cellData,rowData,roe,col){if($(td).html() == '-'){$(td).attr('data-search','');}else{$(td).attr('data-search',$(td).html());$(td).attr('data-order',$(td).attr('data-search'));}}},
        {target:10,'createdCell':function(td,cellData,rowData,roe,col){if($(td).html() == '-'){$(td).attr('data-search','');}else{$(td).attr('data-search',$(td).html());$(td).attr('data-order',$(td).attr('data-search'));}}},
...
moveExportButtonsToTopRight=function () {
  ...
  uptoids=function(dataId,fullName,action){
    ...
    input.val(JSON.stringify(dataId));
  }
