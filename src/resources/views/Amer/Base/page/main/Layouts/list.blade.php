    ...
    <div class="row mb-0">
      <div class="col-sm rounded shadow">
        ...
        <div class="col-sm-12">
          <table
           id="AmerTable" 
           class="table table-light table-striped table-striped-columns table-hover table-sm display table-bordered shadow rounded compact hover row-border cell-border nowrap" 
...
@push('after_scripts')
  ...
  @loadScriptOnce("js/packages/DataTables/Bootstrap-5-5.1.3/js/bootstrap.bundle.js")
  @loadOnce('test_table')
...
@push('after_styles')
  ...
  @loadStyleOnce("js/packages/DataTables/Bootstrap-5-5.1.3/css/bootstrap.css")
@endpush
      <?php
