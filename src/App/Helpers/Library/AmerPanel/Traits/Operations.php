...
trait Operations
{
    ...
    |                               OPERATIONS
    |--------------------------------------------------------------------------
    | Helps developers set and get the current Amer operation, as defined by
    | the contoller method being run.
    */
    protected $currentOperation;

    /**
     * Get the current Amer operation being performed.
     *
    ...
    /**
     * Set the Amer operation being performed in string form.
     *
     ...
     * @param  bool|\Closure  $closure  Code that calls AmerPanel methods.
     * @return void
     */
