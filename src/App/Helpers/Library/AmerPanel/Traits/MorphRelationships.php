...
trait MorphRelationships
{
     ...
     * @return array
     */
    public  function includeMorphToInputsFromRelationship($input)
    {
    ...
    /**
     * This function created the MorphTo relation fields in the AmerPanel.
     *
     * @param  array  $field
     * @return void
     */
    public function createMorphToRelationFields(array $field, $morphTypeFieldName, $morphIdFieldName)
    {
     ...
     * @return array
     */
    public function makeSureMorphSubfieldsAreDefined(array $field)
    {
        if (isset($field['relation_type']) && $field['relation_type'] === 'MorphTo') {
            ...
            if (! $this->hasFieldWhere('name', $morphTypeFieldName) || ! $this->hasFieldWhere('name', $morphIdFieldName)) {
                // create the morph fields in the Amer panel
     ...
     * @return array
     */
    public function getMorphTypeFieldWithOptions(array $morphTypeField, string $key, $label)
    {
     ...
     * @return array
     */
    public function getMorphidFieldStructure($relationName, $morphIdFieldName, $morphTypeFieldName)
    {
        return [
     ...
     * @return array
     */
    public function getMorphTypeFieldStructure($relationName, $morphTypeFieldName)
    {
        return [
     ...
     * @return array
     */
    public function getMorphOptionStructured(array $morphOption)
    {
