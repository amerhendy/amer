...
{
    /**
     * For a simple Amer Panel, there should be no need to add/define the fields.
     ...
     *
     * DEPRECATION NOTICE: This method is no longer used and will be removed in future versions of Amer.Base
     *
     * @deprecated
     */
