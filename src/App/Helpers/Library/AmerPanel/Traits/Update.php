...
trait Update
{
    ...
    */
    ...
    public function getUpdateFields($id = false)
    {
        ...
        if($field['name'] == 'TrainningTimeStart,TrainningTimeEnd'){dd($field['name']);}
    ...
    /**
     * This function checks if the provided model uses the Trait.
    ...
    {
        if (in_array(\Amerhendy\Amer\App\Helpers\Library\AmerPanel\Traits\AmerTrait::class, class_uses_recursive($model))) {
