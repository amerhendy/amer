...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        <a href="{{Route('amer.Citiesweb.index')}}" class="list-group-item list-group-item-action py-2 ripple" aria-current="true">
        ...
        @endif
         <?php 
        dd(File::exists(base_path('vendor/amerhendy/PageManger/composer.json')));
        ?>
