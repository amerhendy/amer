...
if(!isset($field['placeholder'])){
    ...
    $field['placeholder'] = $field['placeholder'] ?? ($field['multiple'] ? trans('AMER::actions.select_entries') : trans('AMER::actions.select_entry'));
    ...
    $field['minimum_input_length'] = ($field['ajax'] !== true) ? 0 : ($field['minimum_input_length'] ?? 0);
...
@endphp
@include(fieldview('relationship.'.$field['type']))
