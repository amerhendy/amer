...
trait CreateOperation
{
    ...
    protected function setupCreateDefaults()
    {
        ...
        $this->Amer->operation('list', function () {
            ...
            if($req->bearerToken() == ""){
                ...
                $this->Amer->addButton('top', 'create', 'view', 'buttons.create');
            }
        });
    ...
    public function create()
    {
        ...
        $this->Amer->hasUploadFields('create') ? $this->Amer->set('isMultipart',true) : $this->Amer->set('isMultipart',false);
        $this->Amer->set('currentOperation','create');
        //dd($this->Amer->getAutoFocusOnFirstField());
        $layout='FormLayout';
        $return=[
            'layout'=>$layout,
