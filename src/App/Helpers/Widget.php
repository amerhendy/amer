...
//use Backpack\Carmen\app\Exceptions\BackpackProRequiredException;
...
class Widget extends Fluent
{
     ...
     * - fallback view paths as configured in config.
     *
     * @return array
     */
    ...
    /**
     * Update the global CarmenPanel object with the current widget attributes.
     *
     * @return Widget
     */
