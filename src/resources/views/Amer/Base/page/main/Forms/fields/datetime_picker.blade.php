<!-- bootstrap datetime_picker input -->
...
?>
    ...
    @loadStyleOnce('js/packages/pc-bootstrap4-datetimepicker/build/css/bootstrap-datetimepicker.min.css')
    @endpush

    {{-- FIELD JS - will be loaded in the after_scripts section --}}
    @push('after_scripts')
    @loadScriptOnce('js/packages/moment/min/moment.min.js')
    @loadScriptOnce('js/packages/pc-bootstrap4-datetimepicker/build/js/bootstrap-datetimepicker.min.js')
    @if ($field_language !== 'en')
    @loadScriptOnce('js/packages/moment/min/locales.min.js')
    @endif
