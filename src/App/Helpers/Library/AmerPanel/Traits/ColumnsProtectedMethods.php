...
trait ColumnsProtectedMethods
{
     ...
     */
    public function makeSureColumnHasPriority($column)
    {
     ...
     * @return array Proper array defining the column.
     */
    public function makeSureColumnHasName($column)
    {
        if (is_string($column)) {
            $column = ['name' => $column];
        }
     ...
     * @return array Proper array defining the column.
     */
    public function makeSureColumnHasLabel($column)
    {
     ...
     */
    public function makeSureColumnHasType($column)
    {
     ...
     */
    public function makeSureColumnHasKey($column)
    {
        if (! isset($column['key'])) {
     ...
     */
    public function makeSureColumnHasWrapper($column)
    {
    ...
    public function makeSureColumnHasEntity($column)
    {
     ...
     */
    public function makeSureColumnHasModel($column)
    {
     ...
     * @return array Column definition array with model.
     */
    public function makeSureColumnHasRelationType($column)
    {
     ...
     */
    public function moveColumn($targetColumn, $before = true)
    {
     ...
     * @return bool
     */
    public function hasDatabaseColumn($table, $name)
    {
        $cache = [];
