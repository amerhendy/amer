...
trait FieldsPrivateMethods
{
     ...
     * @return array
     */
    public function moveField($fields, $targetFieldName, $before = true)
    {
     ...
     */
    public function applyOrderToFields($fields, $order)
    {
        $orderedFields = [];
     ...
     */
    public function transformFields(callable $callback)
    {
