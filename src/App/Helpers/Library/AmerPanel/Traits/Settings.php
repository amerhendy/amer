...
trait Settings
{
    ...
    public  function getOperationSetting(string $key, $operation = null)
    {
        ...
        return $this->get($operation.'.'.$key) ?? config('Amer.Base'.$this->getCurrentOperation().'.'.$key) ?? null;
    }
    ...
    /**
     * Automatically set values in config file 
    ...
    public  function loadDefaultOperationSettingsFromConfig($configPath = null)
    {
        ...
        $configPath = $configPath ?? 'Amer.Base.'.$operation;
