...
use Amerhendy\Amer\App\Helpers\Library\AmerPanel\AmerColumn;
...
trait Columns
{
    ...
    /**
     * Get the Amer columns for the current operation.
     *
     * @return array Amer columns.
     */
    ...
    /**
     * Add a bunch of column names and their details to the Amer object.
     *
    ...
    /**
     * Add a column at the end of to the Amer object's "columns" array.
     *
    ...
    /**
     * Add multiple columns at the end of the Amer object's "columns" array.
     *
     * @param  array  $columns
     */
    ...
    /**
     * Remove a column from the Amer panel by name.
     *
    ...
    /**
     * Remove multiple columns from the Amer panel by name.
     *
    ...
    /**
     * Remove all columns from the Amer panel.
     */
    ...
    /**
     * Get the relationships used in the Amer columns.
     *
    ...
    /**
     * Order the Amer columns. If certain columns are missing from the given order array, they will be pushed to the
     ...
     * in the Amer table view. Usually set to 10000 in order to hide it.
     *
     ...
     * Everything else, Amer.Base can probably guess.
     *
    ...
    public function makeSureColumnHasNeededAttributes($column)
    {
        ...
        // guess an attribute using the identifiableAttribute functionality in AmerTrait
        ...
        if($this->getRequest()->expectsJson()){
            $column['tableColumn'] = true;
        }else{
    ...
    /**
     * Create and return a AmerColumn object for that column name.
     *
     ...
     *
     * And if the developer uses the AmerColumn object as Column in their AmerController:
