    ...
    $inlineCreateButtonElement.on('click', function () {
        ...
        $.ajax({   
            ...
            success: function (result) {
                ...
                $('#loader').hide()
                $inlineCreateButtonElement.hide()
            },
            error: function (result) {
...
function triggerModal(element) {
    ...
    $modalCancelButton.on('click', function () {
        $modal.remove();
        $inlineCreateButtonElement.show()
    });
    ...
    $modalSaveButton.on('click', function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                new Noty({
                    type: "info",
                    text: '{{ trans('AMER::Base.related_entry_created_success') }}',
                }).show();
            },
            error: function (result) {
                ...
                new Noty({
                    type: "error",
                    text: '<strong>{{ trans('AMER::Base.related_entry_created_error') }}</strong><br> '+message,
                }).show();
