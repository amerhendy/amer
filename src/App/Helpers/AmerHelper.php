...
use Amerhendy\Amer\App\Helpers\AmerHelper\{models,arabic,encription,amerModelsHelpers,responses,controllers,arraytrait,bladetrait};
class AmerHelper
{
    use models;
    use arabic,encription,amerModelsHelpers,responses,controllers,arraytrait,bladetrait;
