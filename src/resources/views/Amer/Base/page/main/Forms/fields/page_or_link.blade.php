...
<?php
    $field['options'] = [
        'page_link'     => trans('Amer::crud.page_link'),
        'internal_link' => trans('Amer::crud.internal_link'),
        'external_link' => trans('Amer::crud.external_link'),
    ];
...
?>
    ...
    echo 'd-none';
                ...
                <input
                    ...
                    class="form-control"
                    name="{!! $entry_link !!}"
                    placeholder="{{ trans('Amer::crud.page_link_placeholder') }}"
    ...
    echo 'd-none';
                ...
                <input
                    ...
                    class="form-control"
                    name="{!! $entry_link !!}"
                    placeholder="{{ trans('Amer::crud.internal_link_placeholder', ['url', url(config('Amer.base.route_prefix').'/page')]) }}"
