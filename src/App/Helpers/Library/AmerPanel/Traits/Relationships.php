...
trait Relationships
{
     ...
     * foreign key. Otherwise, we will use the main  fields.
     *
     * eg: user -> user_id
     *
     * @param  array  $input
     ...
     * @return array
     */
    private function getPivotFieldStructure($field)
    {
        ...
        $pivotSelectorField['placeholder'] = trans('Amer::actions.select_entry');
        ...
        $pivotSelectorField['validationMessages'] = [
            'required' => trans('Amer::actions.pivot_selector_required_validation_message'),
        ];
